...
char AnyButtonPressed(void) {
	return !(P2==0xFF);/* @@@ Your code here. returns true  if any bits of P2 is 0; false otherwise.. */;
}
...
char ButtonToChar(void) {
    ...
    /* @@@ Your Code here. depending on the button state, return '6', '5', '4', ¡K '0', or null if no key is pressed or if the combination is not valid.  */
}
