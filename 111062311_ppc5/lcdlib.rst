      ...
      00031D 85 3A 82         [24]  307 	mov	dpl,_lcd_ready
                                    308 ;	lcdlib.c:17: }
      000320 22               [24]  309 	ret
                                    310 ;------------------------------------------------------------
                                    ...
                                    316 ;	-----------------------------------------
      000321                        317 _LCD_Init:
                                    318 ;	lcdlib.c:19: LCD_functionSet();
      000321 12 03 56         [24]  319 	lcall	_LCD_functionSet
                                    320 ;	lcdlib.c:20: LCD_entryModeSet(1, 1); /* increment and no shift */
      000324 75 82 07         [24]  321 	mov	dpl,#0x07
      000327 12 03 34         [24]  322 	lcall	_LCD_IRWrite
                                    323 ;	lcdlib.c:21: LCD_displayOnOffControl(1, 1, 1); /* display on, cursor on and blinking on */
      00032A 75 82 0F         [24]  324 	mov	dpl,#0x0f
      00032D 12 03 34         [24]  325 	lcall	_LCD_IRWrite
                                    326 ;	lcdlib.c:22: lcd_ready = 1;
      000330 75 3A 01         [24]  327 	mov	_lcd_ready,#0x01
                                    328 ;	lcdlib.c:23: }
      000333 22               [24]  329 	ret
                                    330 ;------------------------------------------------------------
                                    ...
                                    338 ;	-----------------------------------------
      000334                        339 _LCD_IRWrite:
      000334 AF 82            [24]  340 	mov	r7,dpl
                                    341 ;	lcdlib.c:25: lcd_ready = 0;
      000336 75 3A 00         [24]  342 	mov	_lcd_ready,#0x00
                                    343 ;	lcdlib.c:26: DB = (c & 0xf0); // high nibble, keep RS low
      000339 74 F0            [12]  344 	mov	a,#0xf0
      00033B 5F               [12]  345 	anl	a,r7
      00033C F5 90            [12]  346 	mov	_P1,a
                                    347 ;	lcdlib.c:27: E = 1;  // pulse E
                                    348 ;	assignBit
      00033E D2 92            [12]  349 	setb	_P1_2
                                    350 ;	lcdlib.c:28: E = 0;
                                    351 ;	assignBit
      000340 C2 92            [12]  352 	clr	_P1_2
                                    353 ;	lcdlib.c:29: DB = (c << 4); // low nibble, keep RS low
      000342 EF               [12]  354 	mov	a,r7
      000343 C4               [12]  355 	swap	a
      000344 54 F0            [12]  356 	anl	a,#0xf0
      000346 F5 90            [12]  357 	mov	_P1,a
                                    358 ;	lcdlib.c:30: E = 1;
                                    359 ;	assignBit
      000348 D2 92            [12]  360 	setb	_P1_2
                                    361 ;	lcdlib.c:31: E = 0;
                                    362 ;	assignBit
      00034A C2 92            [12]  363 	clr	_P1_2
                                    364 ;	lcdlib.c:32: delay(DELAY_AMOUNT);
      00034C 75 82 28         [24]  365 	mov	dpl,#0x28
      00034F 12 03 DF         [24]  366 	lcall	_delay
                                    367 ;	lcdlib.c:33: lcd_ready = 1;
      000352 75 3A 01         [24]  368 	mov	_lcd_ready,#0x01
                                    369 ;	lcdlib.c:34: }
      000355 22               [24]  370 	ret
                                    371 ;------------------------------------------------------------
                                    ...
                                    377 ;	-----------------------------------------
      000356                        378 _LCD_functionSet:
                                    379 ;	lcdlib.c:36: lcd_ready = 0;
      000356 75 3A 00         [24]  380 	mov	_lcd_ready,#0x00
                                    381 ;	lcdlib.c:39: DB = 0x20;  // DB<7:4> = 0010, <RS,E,x,x>=0
      000359 75 90 20         [24]  382 	mov	_P1,#0x20
                                    383 ;	lcdlib.c:40: E = 1;
                                    384 ;	assignBit
      00035C D2 92            [12]  385 	setb	_P1_2
                                    386 ;	lcdlib.c:41: E = 0;
                                    387 ;	assignBit
      00035E C2 92            [12]  388 	clr	_P1_2
                                    389 ;	lcdlib.c:42: delay(DELAY_AMOUNT);
      000360 75 82 28         [24]  390 	mov	dpl,#0x28
      000363 12 03 DF         [24]  391 	lcall	_delay
                                    392 ;	lcdlib.c:43: E = 1;
                                    393 ;	assignBit
      000366 D2 92            [12]  394 	setb	_P1_2
                                    395 ;	lcdlib.c:44: E = 0;
                                    396 ;	assignBit
      000368 C2 92            [12]  397 	clr	_P1_2
                                    398 ;	lcdlib.c:45: delay(DELAY_AMOUNT); // added, to ensure sufficient delay
      00036A 75 82 28         [24]  399 	mov	dpl,#0x28
      00036D 12 03 DF         [24]  400 	lcall	_delay
                                    401 ;	lcdlib.c:46: DB7 = 1; // 2-line model
                                    402 ;	assignBit
      000370 D2 97            [12]  403 	setb	_P1_7
                                    404 ;	lcdlib.c:48: E = 1;
                                    405 ;	assignBit
      000372 D2 92            [12]  406 	setb	_P1_2
                                    407 ;	lcdlib.c:49: E = 0;
                                    408 ;	assignBit
      000374 C2 92            [12]  409 	clr	_P1_2
                                    410 ;	lcdlib.c:50: delay(DELAY_AMOUNT);
      000376 75 82 28         [24]  411 	mov	dpl,#0x28
      000379 12 03 DF         [24]  412 	lcall	_delay
                                    413 ;	lcdlib.c:51: lcd_ready = 1;
      00037C 75 3A 01         [24]  414 	mov	_lcd_ready,#0x01
                                    415 ;	lcdlib.c:52: }
      00037F 22               [24]  416 	ret
                                    417 ;------------------------------------------------------------
                                    ...
                                    425 ;	-----------------------------------------
      000380                        426 _LCD_write_char:
      000380 AF 82            [24]  427 	mov	r7,dpl
                                    428 ;	lcdlib.c:55: lcd_ready = 0;
      000382 75 3A 00         [24]  429 	mov	_lcd_ready,#0x00
                                    430 ;	lcdlib.c:56: DB = (c & 0xf0) | 0x08; //; keep the RS
      000385 74 F0            [12]  431 	mov	a,#0xf0
      000387 5F               [12]  432 	anl	a,r7
      000388 44 08            [12]  433 	orl	a,#0x08
      00038A F5 90            [12]  434 	mov	_P1,a
                                    435 ;	lcdlib.c:57: RS = 1;
                                    436 ;	assignBit
      00038C D2 93            [12]  437 	setb	_P1_3
                                    438 ;	lcdlib.c:58: E = 1;
                                    439 ;	assignBit
      00038E D2 92            [12]  440 	setb	_P1_2
                                    441 ;	lcdlib.c:59: E = 0;
                                    442 ;	assignBit
      000390 C2 92            [12]  443 	clr	_P1_2
                                    444 ;	lcdlib.c:60: DB = (c << 4) | 0x08; // keep the RS
      000392 EF               [12]  445 	mov	a,r7
      000393 C4               [12]  446 	swap	a
      000394 54 F0            [12]  447 	anl	a,#0xf0
      000396 FF               [12]  448 	mov	r7,a
      000397 74 08            [12]  449 	mov	a,#0x08
      000399 4F               [12]  450 	orl	a,r7
      00039A F5 90            [12]  451 	mov	_P1,a
                                    452 ;	lcdlib.c:61: E = 1;
                                    453 ;	assignBit
      00039C D2 92            [12]  454 	setb	_P1_2
                                    455 ;	lcdlib.c:62: E = 0;
                                    456 ;	assignBit
      00039E C2 92            [12]  457 	clr	_P1_2
                                    458 ;	lcdlib.c:63: delay(DELAY_AMOUNT);
      0003A0 75 82 28         [24]  459 	mov	dpl,#0x28
      0003A3 12 03 DF         [24]  460 	lcall	_delay
                                    461 ;	lcdlib.c:64: lcd_ready = 1;
      0003A6 75 3A 01         [24]  462 	mov	_lcd_ready,#0x01
                                    463 ;	lcdlib.c:65: }
      0003A9 22               [24]  464 	ret
                                    465 ;------------------------------------------------------------
                                    ...
                                    473 ;	-----------------------------------------
      0003AA                        474 _LCD_write_string:
      0003AA AD 82            [24]  475 	mov	r5,dpl
      0003AC AE 83            [24]  476 	mov	r6,dph
      0003AE AF F0            [24]  477 	mov	r7,b
                                    478 ;	lcdlib.c:67: while (*str++) {
      0003B0                        479 00101$:
      0003B0 8D 82            [24]  480 	mov	dpl,r5
      0003B2 8E 83            [24]  481 	mov	dph,r6
      0003B4 8F F0            [24]  482 	mov	b,r7
      0003B6 12 05 0E         [24]  483 	lcall	__gptrget
      0003B9 FC               [12]  484 	mov	r4,a
      0003BA A3               [24]  485 	inc	dptr
      0003BB AD 82            [24]  486 	mov	r5,dpl
      0003BD AE 83            [24]  487 	mov	r6,dph
      0003BF EC               [12]  488 	mov	a,r4
      0003C0 60 1C            [24]  489 	jz	00104$
                                    490 ;	lcdlib.c:68: LCD_write_char(*str);
      0003C2 8D 82            [24]  491 	mov	dpl,r5
      0003C4 8E 83            [24]  492 	mov	dph,r6
      0003C6 8F F0            [24]  493 	mov	b,r7
      0003C8 12 05 0E         [24]  494 	lcall	__gptrget
      0003CB F5 82            [12]  495 	mov	dpl,a
      0003CD C0 07            [24]  496 	push	ar7
      0003CF C0 06            [24]  497 	push	ar6
      0003D1 C0 05            [24]  498 	push	ar5
      0003D3 12 03 80         [24]  499 	lcall	_LCD_write_char
      0003D6 D0 05            [24]  500 	pop	ar5
      0003D8 D0 06            [24]  501 	pop	ar6
      0003DA D0 07            [24]  502 	pop	ar7
      0003DC 80 D2            [24]  503 	sjmp	00101$
      0003DE                        504 00104$:
                                    505 ;	lcdlib.c:70: }
      0003DE 22               [24]  506 	ret
                                    507 ;------------------------------------------------------------
      ...
      0003DF                        518 	 dhere:
      0003DF D5 82 FD         [24]  519 	djnz	dpl, dhere
                                    520 ;	lcdlib.c:77: }
      0003E2 22               [24]  521 	ret
                                    522 	.area CSEG    (CODE)
                                    523 	.area CONST   (CODE)
                                    524 	.area XINIT   (CODE)
